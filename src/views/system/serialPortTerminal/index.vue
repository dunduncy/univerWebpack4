<template>
    <div class="box_container">
        <div class="content">
            <Title title="串口终端"></Title>
            <div class="cardsContainer pd">
                <div class="leftCard">
                    <div class="title">详情</div>
                    <div class="cardContent" style="padding-top:10px">
                        <div class="leftCardDevide border pd10">
                            <div class="topTable border pd10">
                                <div class="colDiv">
                                    <div class="rowDiv">
                                        <span class="leftName">串口名</span>
                                        <span class="rightValue">tty01</span>
                                    </div>
                                    <div class="rowDiv">
                                        <span class="leftName">波特率</span>
                                        <span class="rightValue">tty01</span>
                                    </div>
                                </div>
                                <div class="colDiv">
                                    <div class="rowDiv">
                                        <span class="leftName">数据位</span>
                                        <span class="rightValue">tty01</span>
                                    </div>
                                    <div class="rowDiv">
                                        <span class="leftName">停止位</span>
                                        <span class="rightValue">tty01</span>
                                    </div>
                                </div>
                                <div class="colDiv">
                                    <div class="rowDiv">
                                        <span class="leftName">校验位</span>
                                        <span class="rightValue">tty01</span>
                                    </div>
                                </div>
                            </div>
                            <div class="bottomTable">
                                <el-table :data="list2" stripe style="width: 100%;" height="100%" row-key="id"
                                    ...
                                    <el-table-column label="日志" align="center" prop="displayName" />
                                    <el-table-column label="交互输入" align="center" prop="displayName" />
                                    <template slot="empty">
                ...
                <div class="rightCard">
                    <div class="title">串口终端列表</div>
                    <div class="cardContent border">
                        <ul class="serialListContainer">
                            <li @click="changePort(item, index)" v-for="(item, index) in serialPortList" :key="'a' + index"
